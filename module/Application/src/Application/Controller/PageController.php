...
class PageController extends CommonController
{
    ...
    public function indexAction()
    {
        ...
        if($request->isPost()){
            ...
            $callback['questions'] = $this->getServiceLocator()->get("Api\Service\Page")->getElements(1); //TODO: dynamic
            $callback['survey']    = $this->getServiceLocator()->get("Api\Service\Survey")->fetchById($surveyId)->toArray();
            $callback['page']      = $this->getServiceLocator()->get("Api\Service\Page")->fetchById(1)->toArray();
        }
